...
/**
 * Cola de moderacion: lista los enriched items (default `pending`) y deja
 * approve / reject / edit / publish item-by-item.
 *
 * Mantiene un solo `editingItem` para el modal compartido. El boton "Editar"
 * abre el ItemEditor con el item seleccionado y, al guardar, el invalidate
 * de TanStack Query refresca la lista sola.
 */
export function ModerationQueue({ status = "pending" }: ModerationQueueProps) {
